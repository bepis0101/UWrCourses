...
(define (fv [e : Exp] [env : Env]) : (Listof Symbol)
  (type-case Exp e
    ...
    [(varE v) (if (find-env v env) empty (list v))]
    [(letE x l r) (append (fv l env) (fv r (extend-env env x (numV 0))))]
    [(lamE x e) (fv e (extend-env env x (numV 0)))]
    [(appE l r) (append (fv l env) (fv r env))]))
